...
export type AssetTypeId =
  string & { readonly __brand: "AssetTypeId" };

export type OperatorId =
  string & { readonly __brand: "OperatorId" };

export type FinancingApplicationId =
  string & { readonly __brand: "FinancingApplicationId" };

export type FinancingContractId =
  string & { readonly __brand: "FinancingContractId" };

export type RepaymentScheduleId =
  string & { readonly __brand: "RepaymentScheduleId" };

export type InstallmentId =
  string & { readonly __brand: "InstallmentId" };

export type PaymentId =
  string & { readonly __brand: "PaymentId" };

export type DefaultCaseId =
  string & { readonly __brand: "DefaultCaseId" };

export type RecoveryCaseId =
  string & { readonly __brand: "RecoveryCaseId" };

export type CapitalAllocationId =
  string & { readonly __brand: "CapitalAllocationId" };
...
export type FinancingContractStatus =
  | "draft"
  | "pending_activation"
  | "active"
  | "delinquent"
