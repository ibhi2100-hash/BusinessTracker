    ...
    <>
      ...
      >
        <div className="px-5 py-6 border-b border-white/10">
          <p className="text-xs font-medium text-teal-400/80 tracking-wide uppercase">
            Business OS
          </p>
      ...
      <div
        ...
        "
      >
        <GlassCard variant="elevated" className="px-1.5 py-1.5 border-white/15">
            ...
            {primaryNav.map((item) => {
              ...
              return (
                <Link
                  key={item.href}
                  href={item.href}
                  className="flex flex-1 flex-col items-center justify-center gap-0.5 py-1.5 rounded-2xl transition-all active:scale-95"
                >
                  <div
                    className={cn(
      ...
      {moreOpen && (
        <div className="lg:hidden fixed inset-0 z-[60] flex items-end justify-center">
          ...
          >
            ...
            {/* Content */}
            <div className="flex-1 overflow-y-auto px-4 py-4 pb-[max(1.5rem,env(safe-area-inset-bottom))] space-y-6">
              {moreGroups.map((group) => (
                <div key={group.title}>
                    ...
                    {group.items.map((item) => {
                      ...
                      return (
                        ...
                        >
                          <GlassIcon
                            size="sm"
                            variant={active ? "primary" : "primary"}
                          >
      ...
      {/* Desktop content offset helper — use in layout:
          className="lg:pl-64" on main */}
    </>
  );
}